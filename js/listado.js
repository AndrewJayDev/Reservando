...
Listado.prototype.buscarRestaurante = function (idRestABuscar) {
    let findRestaurantRefactored = this.restaurantes.find(function (
        restaurant
    ) {
...
Listado.prototype.obtenerHorarios = function () {
    var arregloHorariosConRepeticiones = this.restaurantes.map(function (
        restaurante
    ) {
